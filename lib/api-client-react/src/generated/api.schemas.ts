...
export interface RigSummary {
  ...
  createdAt: string;
  /** True when the upstream pool is currently unreachable. During a rental this reflects the renter's pool; outside rentals it reflects the owner's fallback pool. Null when state is unknown. */
  poolOffline: boolean | null;
}
